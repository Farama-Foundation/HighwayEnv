...
> :warning: **Stable Baselines3 does not currently support `gym==0.26`**. As of now, these notebooks are only compatible with previous versions of highway-env, such as `highway-env==1.5`
